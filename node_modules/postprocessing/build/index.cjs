...
var Pass = class _Pass {
   ...
   */
  constructor(name = "Pass", scene = new import_three.Scene(), camera = new import_three.OrthographicCamera()) {
    this.name = name;
    this.renderer = null;
    this.scene = scene;
    this.camera = camera;
  ...
  set fullscreenMaterial(value) {
    ...
    if (screen !== null) {
      ...
      screen = new import_three.Mesh(_Pass.fullscreenGeometry, value);
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        depthBuffer: new import_three2.Uniform(null),
        channelWeights: new import_three2.Uniform(null),
    ...
    this.depthFunc = import_three2.AlwaysDepth;
  }
  /**
   * The input buffer.
   *
...
var ASCIITexture = class extends import_three10.CanvasTexture {
  /**
...
var Effect = class extends import_three11.EventDispatcher {
  /**
  ...
  constructor(name, fragmentShader, {
    ...
    this._inputColorSpace = import_three11.LinearSRGBColorSpace;
    this._outputColorSpace = import_three11.NoColorSpace;
  }
  /**
   ...
   */
  setDepthTexture(depthTexture, depthPacking = import_three11.BasicDepthPacking) {
  }
  /**
  ...
  dispose() {
    for (const key of Object.keys(this)) {
      const property = this[key];
      const isDisposable = property instanceof import_three11.WebGLRenderTarget || property instanceof import_three11.Material || property instanceof import_three11.Texture || property instanceof Pass;
      if (isDisposable) {
        this[key].dispose();
      }
    }
...
var ASCIIEffect = class extends Effect {
  ...
  constructor({
    ...
    super("ASCIIEffect", ascii_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["asciiTexture", new import_three12.Uniform(null)],
        ["cellCount", new import_three12.Uniform(new import_three12.Vector4())],
        ["color", new import_three12.Uniform(new import_three12.Color())]
      ])
    });
    this._cellSize = -1;
    this.resolution = new import_three12.Vector2();
...
var KawaseBlurMaterial = class extends import_three13.ShaderMaterial {
  /**
   ...
   */
  constructor(texelSize = new import_three13.Vector4()) {
    super({
      name: "KawaseBlurMaterial",
      uniforms: {
        inputBuffer: new import_three13.Uniform(null),
        texelSize: new import_three13.Uniform(new import_three13.Vector4()),
        scale: new import_three13.Uniform(1),
        kernel: new import_three13.Uniform(0)
      },
...
var KawaseBlurPass = class extends Pass {
  ...
  constructor({
    ...
    this.renderTargetA = new import_three14.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      ...
      if (frameBufferType !== import_three14.UnsignedByteType) {
        this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      } else if (renderer !== null && renderer.outputColorSpace === import_three14.SRGBColorSpace) {
        this.renderTargetA.texture.colorSpace = import_three14.SRGBColorSpace;
        this.renderTargetB.texture.colorSpace = import_three14.SRGBColorSpace;
      }
    }
  }
  /**
...
var LuminanceMaterial = class extends import_three15.ShaderMaterial {
  ...
  constructor(colorOutput = false, luminanceRange = null) {
    super({
      ...
      defines: {
        THREE_REVISION: import_three15.REVISION.replace(/\D+/g, "")
      },
      uniforms: {
...
var LuminancePass = class extends Pass {
   ...
   */
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0 && frameBufferType !== import_three16.UnsignedByteType) {
      this.renderTarget.texture.type = frameBufferType;
      this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
    }
  }
...
// src/materials/DownsamplingMaterial.js
var DownsamplingMaterial = class extends import_three17.ShaderMaterial {
  /**
...
// src/materials/UpsamplingMaterial.js
var UpsamplingMaterial = class extends import_three18.ShaderMaterial {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        supportBuffer: new import_three18.Uniform(null),
        texelSize: new import_three18.Uniform(new import_three18.Vector2()),
        radius: new import_three18.Uniform(0.85)
      },
...
var MipmapBlurPass = class extends Pass {
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      ...
      if (frameBufferType !== import_three19.UnsignedByteType) {
        this.downsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        this.upsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      } else if (renderer !== null && renderer.outputColorSpace === import_three19.SRGBColorSpace) {
        for (const mipmap of mipmaps) {
          mipmap.texture.colorSpace = import_three19.SRGBColorSpace;
        }
      }
    }
  }
...
var BloomEffect = class extends Effect {
  ...
  constructor({
    ...
    super("BloomEffect", bloom_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["map", new import_three20.Uniform(null)],
        ["intensity", new import_three20.Uniform(intensity)]
      ])
    });
    this.renderTarget = new import_three20.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTarget.texture.type = frameBufferType;
      if (renderer !== null && renderer.outputColorSpace === import_three20.SRGBColorSpace) {
        this.renderTarget.texture.colorSpace = import_three20.SRGBColorSpace;
      }
    }
  }
};
...
var BokehEffect = class extends Effect {
  ...
  constructor({
    ...
    super("BokehEffect", bokeh_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["focus", new import_three21.Uniform(focus)],
        ["dof", new import_three21.Uniform(dof)],
        ["aperture", new import_three21.Uniform(aperture)],
        ["maxBlur", new import_three21.Uniform(maxBlur)]
      ])
    });
  }
};
...
var BrightnessContrastEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.SRC, brightness = 0, contrast = 0 } = {}) {
    super("BrightnessContrastEffect", brightness_contrast_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["brightness", new import_three22.Uniform(brightness)],
        ["contrast", new import_three22.Uniform(contrast)]
      ])
    });
    this.inputColorSpace = import_three22.SRGBColorSpace;
  }
  /**
   * The brightness.
   *
...
var ColorDepthEffect = class extends Effect {
  ...
  constructor({ blendFunction, bits = 16 } = {}) {
    super("ColorDepthEffect", color_depth_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["factor", new import_three23.Uniform(1)]
      ])
    });
    this.bits = 0;
    this.bitDepth = bits;
...
var ChromaticAberrationEffect = class extends Effect {
   ...
   */
  constructor({
    offset = new import_three24.Vector2(1e-3, 5e-4),
    ...
    super("ChromaticAberrationEffect", chromatic_aberration_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["offset", new import_three24.Uniform(offset)],
        ["modulationOffset", new import_three24.Uniform(modulationOffset)]
      ])
    });
...
// src/materials/BokehMaterial.js
var BokehMaterial = class extends import_three25.ShaderMaterial {
  /**
  ...
  constructor(fill = false, foreground = false) {
    super({
      ...
      uniforms: {
        ...
        cocBuffer: new import_three25.Uniform(null),
        texelSize: new import_three25.Uniform(new import_three25.Vector2()),
        kernel64: new import_three25.Uniform(null),
        kernel16: new import_three25.Uniform(null),
        scale: new import_three25.Uniform(1)
      },
...
// src/materials/CircleOfConfusionMaterial.js
var CircleOfConfusionMaterial = class extends import_three26.ShaderMaterial {
  /**
  ...
  constructor(camera = null) {
    super({
      ...
      uniforms: {
        depthBuffer: new import_three26.Uniform(null),
        projectionMatrix: new import_three26.Uniform(null),
        projectionMatrixInverse: new import_three26.Uniform(null),
        cameraNear: new import_three26.Uniform(0.3),
        cameraFar: new import_three26.Uniform(1e3),
        focusDistance: new import_three26.Uniform(0),
        focusRange: new import_three26.Uniform(0)
      },
   ...
   */
  setDepthBuffer(buffer, depthPacking = import_three26.BasicDepthPacking) {
  ...
  copyCameraSettings(camera) {
    ...
    if (camera instanceof import_three26.PerspectiveCamera) {
...
// src/materials/MaskMaterial.js
var MaskMaterial = class extends import_three27.ShaderMaterial {
  /**
  ...
  constructor(maskTexture = null) {
    super({
      name: "MaskMaterial",
      uniforms: {
        maskTexture: new import_three27.Uniform(maskTexture),
        inputBuffer: new import_three27.Uniform(null),
        strength: new import_three27.Uniform(1)
      },
      blending: import_three27.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
  ...
  set maskTexture(value) {
    ...
    if (value.type !== import_three27.UnsignedByteType) {
...
var ShaderPass = class extends Pass {
   ...
   */
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0 && frameBufferType !== import_three28.UnsignedByteType) {
      this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
    }
  }
};
...
// src/effects/DepthOfFieldEffect.js
var v = /* @__PURE__ */ new import_three29.Vector3();
var DepthOfFieldEffect = class extends Effect {
  ...
  constructor(camera, {
    ...
    super("DepthOfFieldEffect", depth_of_field_default, {
      ...
      attributes: EffectAttribute.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["nearColorBuffer", new import_three29.Uniform(null)],
        ["farColorBuffer", new import_three29.Uniform(null)],
        ["nearCoCBuffer", new import_three29.Uniform(null)],
        ["farCoCBuffer", new import_three29.Uniform(null)],
        ["scale", new import_three29.Uniform(1)]
      ])
    });
    this.camera = camera;
    this.renderTarget = new import_three29.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    this.blurPass.initialize(renderer, alpha, import_three29.UnsignedByteType);
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer !== null && renderer.outputColorSpace === import_three29.SRGBColorSpace) {
        this.renderTarget.texture.colorSpace = import_three29.SRGBColorSpace;
        this.renderTargetNear.texture.colorSpace = import_three29.SRGBColorSpace;
        this.renderTargetFar.texture.colorSpace = import_three29.SRGBColorSpace;
        this.renderTargetMasked.texture.colorSpace = import_three29.SRGBColorSpace;
      }
    }
  }
};
...
var DotScreenEffect = class extends Effect {
  ...
  constructor({ blendFunction, angle = Math.PI * 0.5, scale = 1 } = {}) {
    super("DotScreenEffect", dot_screen_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["angle", new import_three30.Uniform(new import_three30.Vector2())],
        ["scale", new import_three30.Uniform(scale)]
      ])
    });
    this.angle = angle;
  }
...
var GammaCorrectionEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.SRC, gamma = 2 } = {}) {
    super("GammaCorrectionEffect", gamma_correction_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["gamma", new import_three31.Uniform(gamma)]
      ])
    });
  }
};
...
function getNoise(size, format, type) {
  const channels = /* @__PURE__ */ new Map([
    [import_three32.RedFormat, 1],
    [import_three32.RGFormat, 2],
    [import_three32.RGBAFormat, 4]
  ]);
  let data;
  if (!channels.has(format)) {
    console.error("Invalid noise texture format");
  }
  if (type === import_three32.UnsignedByteType) {
...
var NoiseTexture = class extends import_three32.DataTexture {
  /**
   ...
   */
  constructor(width, height, format = import_three32.RedFormat, type = import_three32.UnsignedByteType) {
...
var GlitchEffect = class extends Effect {
  ...
  constructor({
    ...
    delay = new import_three33.Vector2(1.5, 3.5),
    duration = new import_three33.Vector2(0.6, 1),
    strength = new import_three33.Vector2(0.3, 1),
    columns = 0.05,
    ratio = 0.85,
    ...
    super("GlitchEffect", glitch_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["perturbationMap", new import_three33.Uniform(null)],
        ["columns", new import_three33.Uniform(columns)],
        ["active", new import_three33.Uniform(false)],
        ["random", new import_three33.Uniform(1)],
        ["seeds", new import_three33.Uniform(new import_three33.Vector2())],
        ["distortion", new import_three33.Uniform(new import_three33.Vector2())]
      ])
    });
    if (perturbationMap === null) {
      const map = new NoiseTexture(dtSize, dtSize, import_three33.RGBAFormat);
      map.name = textureTag;
    ...
    this.breakPoint = new import_three33.Vector2(
  ...
  set perturbationMap(value) {
    ...
    value.minFilter = value.magFilter = import_three33.NearestFilter;
    value.wrapS = value.wrapT = import_three33.RepeatWrapping;
  ...
  generatePerturbationMap(value = 64) {
    const map = new NoiseTexture(value, value, import_three33.RGBAFormat);
    map.name = textureTag;
    return map;
  }
  /**
...
// src/effects/GodRaysEffect.js
var v2 = /* @__PURE__ */ new import_three35.Vector3();
...
var GodRaysEffect = class extends Effect {
  ...
  constructor(camera, lightSource, {
    ...
    this.copyPass.fullscreenMaterial.channelWeights = new import_three35.Vector4(0, 0, 0, 1);
...
var DepthPass = class extends Pass {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    clearPass.overrideClearColor = new import_three44.Color(clearColor);
...
var v3 = /* @__PURE__ */ new import_three49.Vector3();
...
// src/materials/DepthMaskMaterial.js
var DepthMaskMaterial = class extends import_three50.ShaderMaterial {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        inputBuffer: new import_three50.Uniform(null),
        depthBuffer0: new import_three50.Uniform(null),
        depthBuffer1: new import_three50.Uniform(null),
        cameraNearFar: new import_three50.Uniform(new import_three50.Vector2(1, 1))
      },
      blending: import_three50.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
    ...
    this.depthMode = import_three50.LessDepth;
  }
  /**
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer0(buffer, depthPacking = import_three50.BasicDepthPacking) {
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer1(buffer, depthPacking = import_three50.BasicDepthPacking) {
  ...
  set depthMode(value) {
    let depthTest;
    switch (value) {
      case import_three50.NeverDepth:
        depthTest = "false";
        break;
      case import_three50.AlwaysDepth:
        depthTest = "true";
        break;
      case import_three50.EqualDepth:
        depthTest = "abs(d1 - d0) <= DEPTH_EPSILON";
        break;
      case import_three50.NotEqualDepth:
        depthTest = "abs(d1 - d0) > DEPTH_EPSILON";
        break;
      case import_three50.LessDepth:
        depthTest = "d0 > d1";
        break;
      case import_three50.LessEqualDepth:
        depthTest = "d0 >= d1";
        break;
      case import_three50.GreaterEqualDepth:
        depthTest = "d0 <= d1";
        break;
      case import_three50.GreaterDepth:
      default:
        depthTest = "d0 < d1";
        break;
    }
  ...
  copyCameraSettings(camera) {
    if (camera) {
      ...
      if (camera instanceof import_three50.PerspectiveCamera) {
        this.defines.PERSPECTIVE_CAMERA = "1";
      } else {
        delete this.defines.PERSPECTIVE_CAMERA;
      }
...
var SelectiveBloomEffect = class extends BloomEffect {
  ...
  constructor(scene, camera, options) {
    ...
    this.clearPass.overrideClearColor = new import_three51.Color(0);
    ...
    depthMaskMaterial.depthPacking1 = import_three51.RGBADepthPacking;
    depthMaskMaterial.depthMode = import_three51.EqualDepth;
    this.renderTargetMasked = new import_three51.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  set inverted(value) {
    ...
    this.depthMaskMaterial.depthMode = value ? import_three51.NotEqualDepth : import_three51.EqualDepth;
  }
  /**
   * Indicates whether the mask is inverted.
   *
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing.
   */
  setDepthTexture(depthTexture, depthPacking = import_three51.BasicDepthPacking) {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTargetMasked.texture.type = frameBufferType;
      if (renderer !== null && renderer.outputColorSpace === import_three51.SRGBColorSpace) {
        this.renderTargetMasked.texture.colorSpace = import_three51.SRGBColorSpace;
      }
    }
  }
};
...
var SepiaEffect = class extends Effect {
  ...
  constructor({ blendFunction, intensity = 1 } = {}) {
    super("SepiaEffect", sepia_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["weightsR", new import_three52.Uniform(new import_three52.Vector3(0.393, 0.769, 0.189))],
        ["weightsG", new import_three52.Uniform(new import_three52.Vector3(0.349, 0.686, 0.168))],
        ["weightsB", new import_three52.Uniform(new import_three52.Vector3(0.272, 0.534, 0.131))]
      ])
    });
  }
  /**
...
// src/materials/EdgeDetectionMaterial.js
var EdgeDetectionMaterial = class extends import_three53.ShaderMaterial {
  /**
   ...
   */
  constructor(texelSize = new import_three53.Vector2(), mode = EdgeDetectionMode.COLOR) {
    super({
      name: "EdgeDetectionMaterial",
      defines: {
        THREE_REVISION: import_three53.REVISION.replace(/\D+/g, ""),
      ...
      uniforms: {
        ...
        depthBuffer: new import_three53.Uniform(null),
        predicationBuffer: new import_three53.Uniform(null),
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer(buffer, depthPacking = import_three53.BasicDepthPacking) {
    this.depthBuffer = buffer;
    this.depthPacking = depthPacking;
  }
  /**
...
// src/materials/SMAAWeightsMaterial.js
var SMAAWeightsMaterial = class extends import_three54.ShaderMaterial {
  /**
   ...
   */
  constructor(texelSize = new import_three54.Vector2(), resolution = new import_three54.Vector2()) {
    super({
      ...
      uniforms: {
        inputBuffer: new import_three54.Uniform(null),
        searchTexture: new import_three54.Uniform(null),
        areaTexture: new import_three54.Uniform(null),
        resolution: new import_three54.Uniform(resolution),
        texelSize: new import_three54.Uniform(texelSize)
      },
      blending: import_three54.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
...
var SMAAEffect = class extends Effect {
  ...
  constructor({
    ...
    super("SMAAEffect", smaa_default, {
      ...
      attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["weightMap", new import_three55.Uniform(null)]
      ])
    });
    ...
    this.renderTargetEdges = new import_three55.WebGLRenderTarget(1, 1, { depthBuffer: false });
    ...
    const loadingManager = new import_three55.LoadingManager();
    loadingManager.onLoad = () => {
      const searchTexture = new import_three55.Texture(searchImage);
      searchTexture.name = "SMAA.Search";
      searchTexture.magFilter = import_three55.NearestFilter;
      searchTexture.minFilter = import_three55.NearestFilter;
      searchTexture.generateMipmaps = false;
      searchTexture.needsUpdate = true;
      searchTexture.flipY = true;
      this.weightsMaterial.searchTexture = searchTexture;
      const areaTexture = new import_three55.Texture(areaImage);
      areaTexture.name = "SMAA.Area";
      areaTexture.magFilter = import_three55.LinearFilter;
      areaTexture.minFilter = import_three55.LinearFilter;
...
// src/materials/SSAOMaterial.js
var SSAOMaterial = class extends import_three56.ShaderMaterial {
  /**
  ...
  constructor(camera) {
    super({
      ...
      uniforms: {
        ...
        normalDepthBuffer: new import_three56.Uniform(null),
        noiseTexture: new import_three56.Uniform(null),
        inverseProjectionMatrix: new import_three56.Uniform(new import_three56.Matrix4()),
        projectionMatrix: new import_three56.Uniform(new import_three56.Matrix4()),
        texelSize: new import_three56.Uniform(new import_three56.Vector2()),
        cameraNearFar: new import_three56.Uniform(new import_three56.Vector2()),
        distanceCutoff: new import_three56.Uniform(new import_three56.Vector2()),
        proximityCutoff: new import_three56.Uniform(new import_three56.Vector2()),
        noiseScale: new import_three56.Uniform(new import_three56.Vector2()),
        minRadiusScale: new import_three56.Uniform(0.33),
        intensity: new import_three56.Uniform(1),
        fade: new import_three56.Uniform(0.01),
        bias: new import_three56.Uniform(0)
      },
  ...
  copyCameraSettings(camera) {
    if (camera) {
      ...
      if (camera instanceof import_three56.PerspectiveCamera) {
        this.defines.PERSPECTIVE_CAMERA = "1";
      } else {
        delete this.defines.PERSPECTIVE_CAMERA;
      }
...
// src/materials/DepthDownsamplingMaterial.js
var DepthDownsamplingMaterial = class extends import_three57.ShaderMaterial {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        depthBuffer: new import_three57.Uniform(null),
        normalBuffer: new import_three57.Uniform(null),
        texelSize: new import_three57.Uniform(new import_three57.Vector2())
      },
      blending: import_three57.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer(buffer, depthPacking = import_three57.BasicDepthPacking) {
    this.depthBuffer = buffer;
    this.depthPacking = depthPacking;
  }
  /**
...
var DepthDownsamplingPass = class extends Pass {
  ...
  constructor({
    ...
    this.needsSwap = false;
    this.renderTarget = new import_three58.WebGLRenderTarget(1, 1, {
      minFilter: import_three58.NearestFilter,
      magFilter: import_three58.NearestFilter,
      depthBuffer: false,
      type: import_three58.FloatType
    });
...
var SSAOEffect = class extends Effect {
  ...
  constructor(camera, normalBuffer, {
    ...
    super("SSAOEffect", ssao_default3, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["aoBuffer", new import_three59.Uniform(null)],
        ["normalDepthBuffer", new import_three59.Uniform(normalDepthBuffer)],
        ["luminanceInfluence", new import_three59.Uniform(luminanceInfluence)],
        ["color", new import_three59.Uniform(null)],
        ["intensity", new import_three59.Uniform(intensity)],
        ["scale", new import_three59.Uniform(0)]
        // Unused.
      ])
    });
    this.renderTarget = new import_three59.WebGLRenderTarget(1, 1, { depthBuffer: false });
    ...
    const noiseTexture = new NoiseTexture(NOISE_TEXTURE_SIZE, NOISE_TEXTURE_SIZE, import_three59.RGBAFormat);
    noiseTexture.wrapS = noiseTexture.wrapT = import_three59.RepeatWrapping;
  ...
  set color(value) {
    ...
    if (value !== null) {
      if (defines.has("COLORIZE")) {
        ...
        uniforms.get("color").value = new import_three59.Color(value);
        this.setChanged();
      }
  ...
  constructor({ blendFunction, texture = null, aspectCorrection = false } = {}) {
    super("TextureEffect", texture_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["scale", new import_three60.Uniform(1)],
        ["uvTransform", new import_three60.Uniform(null)]
      ])
    });
  ...
  set texture(value) {
    ...
    if (prevTexture !== value) {
      ...
      if (value !== null) {
        ...
        if (value.type !== import_three60.UnsignedByteType) {
...
var TiltShiftBlurMaterial = class extends KawaseBlurMaterial {
  ...
  constructor({
    ...
    this.uniforms.aspect = new import_three61.Uniform(1);
    this.uniforms.rotation = new import_three61.Uniform(new import_three61.Vector2());
    this.uniforms.maskParams = new import_three61.Uniform(new import_three61.Vector4());
    this._offset = offset;
...
var TiltShiftEffect = class extends Effect {
  ...
  constructor({
    ...
    super("TiltShiftEffect", tilt_shift_default, {
      ...
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["rotation", new import_three62.Uniform(new import_three62.Vector2())],
        ["maskParams", new import_three62.Uniform(new import_three62.Vector2())],
        ["map", new import_three62.Uniform(null)]
      ])
    });
    this._offset = offset;
    this._focusArea = focusArea;
    this._feather = feather;
    this.renderTarget = new import_three62.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTarget.texture.type = frameBufferType;
      if (renderer !== null && renderer.outputColorSpace === import_three62.SRGBColorSpace) {
        this.renderTarget.texture.colorSpace = import_three62.SRGBColorSpace;
      }
    }
  }
};
...
// src/materials/AdaptiveLuminanceMaterial.js
var AdaptiveLuminanceMaterial = class extends import_three63.ShaderMaterial {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        luminanceBuffer0: new import_three63.Uniform(null),
        luminanceBuffer1: new import_three63.Uniform(null),
        minLuminance: new import_three63.Uniform(0.01),
        deltaTime: new import_three63.Uniform(0),
        tau: new import_three63.Uniform(1)
      },
      extensions: {
        shaderTextureLOD: true
      },
      blending: import_three63.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
...
var AdaptiveLuminancePass = class extends Pass {
  ...
  constructor(luminanceBuffer, { minLuminance = 0.01, adaptationRate = 1 } = {}) {
    ...
    this.needsSwap = false;
    this.renderTargetPrevious = new import_three64.WebGLRenderTarget(1, 1, {
      minFilter: import_three64.NearestFilter,
      magFilter: import_three64.NearestFilter,
      depthBuffer: false
    });
...
var ToneMappingEffect = class extends Effect {
  ...
  constructor({
    ...
    super("ToneMappingEffect", tone_mapping_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["luminanceBuffer", new import_three65.Uniform(null)],
        ["maxLuminance", new import_three65.Uniform(maxLuminance)],
        // Unused
        ["whitePoint", new import_three65.Uniform(whitePoint)],
        ["middleGrey", new import_three65.Uniform(middleGrey)],
        ["averageLuminance", new import_three65.Uniform(averageLuminance)]
      ])
    });
    this.renderTargetLuminance = new import_three65.WebGLRenderTarget(1, 1, {
      minFilter: import_three65.LinearMipmapLinearFilter,
      depthBuffer: false
    });
  ...
  set mode(value) {
    ...
    const revision = import_three65.REVISION.replace(/\D+/g, "");
...
var VignetteEffect = class extends Effect {
  ...
  constructor({
    ...
    super("VignetteEffect", vignette_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["offset", new import_three66.Uniform(offset)],
        ["darkness", new import_three66.Uniform(darkness)]
      ])
    });
  }
  /**
...
var LUT3dlLoader = class extends import_three67.Loader {
  /**
   * Loads a LUT.
   *
...
var LUTCubeLoader = class extends import_three68.Loader {
  /**
   * Loads a LUT.
   *
  ...
  parse(input) {
    ...
    const data = new Float32Array(size ** 3 * 4);
    const domainMin = new import_three68.Vector3(0, 0, 0);
    const domainMax = new import_three68.Vector3(1, 1, 1);
...
var SMAAImageLoader = class extends import_three69.Loader {
  /**
...
// src/materials/BoxBlurMaterial.js
var BoxBlurMaterial = class extends import_three70.ShaderMaterial {
  /**
  ...
  constructor({ bilateral = false, kernelSize = 5 } = {}) {
    super({
      ...
      uniforms: {
        ...
        normalDepthBuffer: new import_three70.Uniform(null),
        texelSize: new import_three70.Uniform(new import_three70.Vector2()),
        cameraNearFar: new import_three70.Uniform(new import_three70.Vector2()),
        scale: new import_three70.Uniform(1)
      },
...
// src/materials/DepthCopyMaterial.js
var DepthCopyMaterial = class extends import_three71.ShaderMaterial {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        texelPosition: new import_three71.Uniform(new import_three71.Vector2())
      },
...
// src/materials/EffectMaterial.js
var EffectMaterial = class extends import_three72.ShaderMaterial {
  /**
  ...
  constructor(shaderParts, defines, uniforms, camera, dithering = false) {
    super({
      name: "EffectMaterial",
      defines: {
        THREE_REVISION: import_three72.REVISION.replace(/\D+/g, ""),
        DEPTH_PACKING: "0",
        ENCODE_OUTPUT: "1"
      },
      uniforms: {
        inputBuffer: new import_three72.Uniform(null),
        depthBuffer: new import_three72.Uniform(null),
        resolution: new import_three72.Uniform(new import_three72.Vector2()),
        texelSize: new import_three72.Uniform(new import_three72.Vector2()),
        cameraNear: new import_three72.Uniform(0.3),
        cameraFar: new import_three72.Uniform(1e3),
        aspect: new import_three72.Uniform(1),
        time: new import_three72.Uniform(0)
      },
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer(buffer, depthPacking = import_three72.BasicDepthPacking) {
    this.depthBuffer = buffer;
    this.depthPacking = depthPacking;
  }
  /**
  ...
  copyCameraSettings(camera) {
    if (camera) {
      this.uniforms.cameraNear.value = camera.near;
      this.uniforms.cameraFar.value = camera.far;
      if (camera instanceof import_three72.PerspectiveCamera) {
        this.defines.PERSPECTIVE_CAMERA = "1";
      } else {
        delete this.defines.PERSPECTIVE_CAMERA;
      }
...
// src/materials/GaussianBlurMaterial.js
var GaussianBlurMaterial = class extends import_three73.ShaderMaterial {
  /**
   * Constructs a new convolution material.
   *
   * @param {Object} [options] - The options.
  ...
  constructor({ kernelSize = 35 } = {}) {
    super({
      ...
      uniforms: {
        inputBuffer: new import_three73.Uniform(null),
        texelSize: new import_three73.Uniform(new import_three73.Vector2()),
        direction: new import_three73.Uniform(new import_three73.Vector2()),
        kernel: new import_three73.Uniform(null),
        scale: new import_three73.Uniform(1)
      },
      blending: import_three73.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
...
var BoxBlurPass = class extends Pass {
  ...
  constructor({
    ...
    this.renderTargetA = new import_three74.WebGLRenderTarget(1, 1, { depthBuffer: false });
    this.renderTargetA.texture.name = "Blur.Target.A";
    this.renderTargetB = new import_three74.WebGLRenderTarget(1, 1, { depthBuffer: false });
    this.renderTargetB.texture.name = "Blur.Target.B";
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTargetA.texture.type = frameBufferType;
      this.renderTargetB.texture.type = frameBufferType;
      if (frameBufferType !== import_three74.UnsignedByteType) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      } else if (renderer !== null && renderer.outputColorSpace === import_three74.SRGBColorSpace) {
        this.renderTargetA.texture.colorSpace = import_three74.SRGBColorSpace;
        this.renderTargetB.texture.colorSpace = import_three74.SRGBColorSpace;
      }
    }
  }
};
...
var DepthCopyPass = class extends Pass {
   ...
   */
  constructor({ depthPacking = import_three75.RGBADepthPacking } = {}) {
    super("DepthCopyPass");
    ...
    this.needsDepthTexture = true;
    this.needsSwap = false;
    this.renderTarget = new import_three75.WebGLRenderTarget(1, 1, {
      type: depthPacking === import_three75.RGBADepthPacking ? import_three75.UnsignedByteType : import_three75.FloatType,
      minFilter: import_three75.NearestFilter,
      magFilter: import_three75.NearestFilter,
      depthBuffer: false
    });
...
// src/passes/DepthPickingPass.js
var threeRevision = Number(import_three76.REVISION.replace(/\D+/g, ""));
...
var DepthPickingPass = class extends DepthCopyPass {
   ...
   */
  constructor({ depthPacking = import_three76.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
    if (depthPacking !== import_three76.RGBADepthPacking && depthPacking !== import_three76.BasicDepthPacking) {
      throw new Error(`Unsupported depth packing: ${depthPacking}`);
    }
    super({ depthPacking });
    this.name = "DepthPickingPass";
    this.fullscreenMaterial.mode = mode;
    this.pixelBuffer = depthPacking === import_three76.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
    this.callback = null;
  }
  /**
  ...
  render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
    ...
    if (this.callback !== null) {
      ...
      const packed = renderTarget.texture.type !== import_three76.FloatType;
      let x = 0, y = 0;
...
`;
    ...
    if (mainImageExists) {
      if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
        fragmentMainImage += effect.inputColorSpace === import_three77.SRGBColorSpace ? "color0 = sRGBTransferOETF(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
      }
      if (effect.outputColorSpace !== import_three77.NoColorSpace) {
...
var EffectPass = class extends Pass {
  ...
  updateMaterial() {
    ...
    if (data.colorSpace === import_three77.SRGBColorSpace) {
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing.
   */
  setDepthTexture(depthTexture, depthPacking = import_three77.BasicDepthPacking) {
    this.fullscreenMaterial.depthBuffer = depthTexture;
    this.fullscreenMaterial.depthPacking = depthPacking;
    for (const effect of this.effects) {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    this.updateMaterial();
    if (frameBufferType !== void 0 && frameBufferType !== import_three77.UnsignedByteType) {
      this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
    }
  }
  /**
...
var GaussianBlurPass = class extends Pass {
  ...
  constructor({
    ...
    this.renderTargetA = new import_three78.WebGLRenderTarget(1, 1, { depthBuffer: false });
    this.renderTargetA.texture.name = "Blur.Target.A";
    this.renderTargetB = this.renderTargetA.clone();
    this.renderTargetB.texture.name = "Blur.Target.B";
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      this.renderTargetA.texture.type = frameBufferType;
      this.renderTargetB.texture.type = frameBufferType;
      if (frameBufferType !== import_three78.UnsignedByteType) {
        this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      } else if (renderer !== null && renderer.outputColorSpace === import_three78.SRGBColorSpace) {
        this.renderTargetA.texture.colorSpace = import_three78.SRGBColorSpace;
        this.renderTargetB.texture.colorSpace = import_three78.SRGBColorSpace;
      }
    }
  }
};
...
var import_three79 = require("three");
var NormalPass = class extends Pass {
  ...
  constructor(scene, camera, {
    ...
    super("NormalPass");
    this.needsSwap = false;
    this.renderPass = new RenderPass(scene, camera, new import_three79.MeshNormalMaterial());
    const renderPass = this.renderPass;
    renderPass.ignoreBackground = true;
    renderPass.skipShadowMapUpdate = true;
    const clearPass = renderPass.getClearPass();
    clearPass.overrideClearColor = new import_three79.Color(7829503);
    clearPass.overrideClearAlpha = 1;
    this.renderTarget = renderTarget;
    if (this.renderTarget === void 0) {
      this.renderTarget = new import_three79.WebGLRenderTarget(1, 1, {
        minFilter: import_three79.NearestFilter,
        magFilter: import_three79.NearestFilter
      });
...
var import_three80 = require("three");
  ...
  generate() {
    ...
    return promise.then((urls) => {
      return new Promise((resolve, reject) => {
        const searchImage = new Image();
        const areaImage = new Image();
        const manager = new import_three80.LoadingManager();
