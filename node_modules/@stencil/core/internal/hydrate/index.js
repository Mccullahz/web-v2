...
var attachStyles = (hostRef) => {
  ...
  if ((BUILD10.shadowDom || BUILD10.scoped) && BUILD10.cssAnnotations && flags & 10 /* needsScopedEncapsulation */) {
    elm["s-sc"] = scopeId2;
...
var createElm = (oldParentVNode, newParentVNode, childIndex) => {
  ...
  if (BUILD13.vdomText && newVNode2.$text$ !== null) {
    ...
    if ((BUILD13.scoped || BUILD13.hydrateServerSide && 128 /* shadowNeedsScopedCss */) && isDef(scopeId) && elm["s-si"] !== scopeId) {
  ...
  if (BUILD13.slotRelocation) {
    if (newVNode2.$flags$ & (2 /* isSlotFallback */ | 1 /* isSlotReference */)) {
      ...
      if (BUILD13.scoped || BUILD13.hydrateServerSide && 128 /* shadowNeedsScopedCss */) {
...
function hydrateApp(win2, opts, results, afterHydrate, resolve) {
  ...
  try {
    ...
    var patchedConnectedCallback = patchedConnectedCallback2, patchElement = patchElement2, patchChild = patchChild2, connectElement = connectElement2, waitLoop = waitLoop2;
